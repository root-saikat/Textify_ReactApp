        ...
        <div className="container">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav me-auto mb-2 mb-lg-0 mx-auto gap-2">
                    ...
                    <a className="nav-link active" aria-current="page" href="/">{props.navItemOne}</a>
                    </li>
                    <li className="nav-item">
                    <a className="nav-link" href="/">{props.navItemTwo}</a>
                    </li>
                    <li className="nav-item">
                    <a className="nav-link" href="/">{props.navItemThree}</a>
                    </li>
                </ul>
